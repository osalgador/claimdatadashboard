import pandas as pd
import numpy as np
#importramos nuestros datos como dataframes
...
dfcarIns.info()
dfcarIns.head()
#Eliminaremos datos vacíos y datos que no aporten al modelo
dfcarIns.isnull().sum()
...
dfcarIns['power_weight_ratio'] = dfcarIns['max_power'] / dfcarIns['gross_weight']
#con esta variable veremos que tan potente es el vehículo conforme a su peso
dfcarIns['young_driver'] = (dfcarIns['customer_age'] < 25).astype(int)
#estadísticamente los jovenes menores de 25 tienden a tener más accidentes
